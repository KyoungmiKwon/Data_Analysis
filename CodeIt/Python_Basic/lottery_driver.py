...
def main(winning_numbers, tries, total_prize, total_cost):
    out_file = open('Python/Codeit/PJT_lottery.html', 'w', encoding='utf-8')
...
WINNING_NUMBERS = PJT_lottery.draw_winning_numbers()
NUM_TRIES = 100
...
for i in range(NUM_TRIES):
    attempt = sorted(PJT_lottery.generate_numbers(6))
    prize = PJT_lottery.check(attempt, WINNING_NUMBERS)
